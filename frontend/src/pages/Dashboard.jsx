...
export default function Dashboard() {
  ...
  // a Manager-style view of their sub-team. A toggle at the top switches
  // between the two. Defaults to "team" since the SeniorTM oversight view is
